...
import br.org.pibfortaleza.somosamp.adapters.PostAdapter;
...
public class PostsFragment extends Fragment {
    ...
    public static PostsFragment newInstance(String param1, String param2,String param3) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            switch (mParam1){
                case "AUTOR":
                    posts = postDAO.listarPostsPorAutor(mParam2);
                    break;
                case "CATEGORIA":
                    posts = postDAO.listarPostsPorCategoria(mParam2);
                    break;
            }

            if (((MainActivity)getActivity()).getSupportActionBar() != null){
                ((MainActivity)getActivity()).getSupportActionBar().setTitle(mParam3);
            }
